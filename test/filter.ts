...
//         if (!matched && op === "and") return false;
//         if (matched && op === "not") return false;
//         if (matched && op === "or") return true;
//       }
//       return op !== "or" || !o.length;
//     } else if (typeof o === "object" && o !== null) {
//       for (let k in o) {
//         let matched;
//         if (k.startsWith(".")) matched = _exec(o[k], k.substr(1), field);
//         else matched = _exec(o[k], "eq", k);
//         if (!matched && op === "and") return false;
//         if (matched && op === "not") return false;
//         if (matched && op === "or") return true;
//       }
